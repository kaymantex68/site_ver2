...
function Calc() {
    ...
    return (
        <div className={classes.CalcMain}>
            <p className={classes.p_ABZ}>Ток нулевого проводника <span className={classes.Pink}>3х ФАЗНОЙ</span> сети при <span className={classes.Pink}>НЕСИММЕТРИЧНОЙ</span> нагрузке</p>
            ...
            <p className={classes.p_ABZ}><span className={classes.Green}>N</span></p>
